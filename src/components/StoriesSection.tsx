    ...
    <section id="historias" className="py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center mb-4 px-4 py-2 rounded-full bg-blue-50">
            <BookOpenIcon className="h-8 w-8 text-blue-500 mr-2" />
            <h2 className="text-3xl font-bold text-gray-900">Simulações Financeiras</h2>
          </div>
